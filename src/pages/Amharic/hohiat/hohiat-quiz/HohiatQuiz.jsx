...
import { auth, db } from "../../../../firebase"; // Adjusted path to point to src/firebase
import { doc, updateDoc, getDoc } from "firebase/firestore";
import '../../../styles/AlphabetQuiz.css'; // Adjusted path to point to src/pages/styles/AlphabetQuiz.css
import soundA from '../../../../assets/alphabets/A.wav'; // Adjusted path to point to src/assets/alphabets
