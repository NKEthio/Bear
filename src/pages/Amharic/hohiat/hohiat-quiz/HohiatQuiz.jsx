...
import { auth, db } from "../../../../firebase"; // Corrected 4 levels path
import { doc, updateDoc, getDoc } from "firebase/firestore";
import '../../../styles/AlphabetQuiz.css'; // Corrected 3 levels path
import soundA from '../../../../assets/alphabets/A.wav'; // Corrected 4 levels path
...
export default function AlphabetQuiz() {
  ...
  const playSound = useCallback((soundFile) => {
    if (soundFile && !isPlayingRef.current) {
      if (!audioRef.current) {
