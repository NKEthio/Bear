...
import { auth, db } from "../../../../firebase"; // Adjust path to four levels
...
// Hoist static questions array outside of the component to avoid re-allocation during render cycles.
// We also use sound paths instead of pre-allocating heavy 'new Audio()' objects upfront.
const QUESTIONS = [
  [
...
export default function AlphabetQuiz() {
  ...
  // Lazy initialize a single, reusable Audio element in useRef to drastically reduce memory/CPU footprint
  ...
  }, [setAlphabet, setNumber, playSound]);
